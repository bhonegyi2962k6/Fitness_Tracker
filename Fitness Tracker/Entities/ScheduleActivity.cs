...
namespace Fitness_Tracker.Entities
{
    ...
    {
        private int scheduleActivityId;
        ...
        public ScheduleActivity(int scheduleActivityId, Schedule schedule, Activity activity, TimeSpan startTime, int durationMinutes)
        {
        ...
        public int ScheduleActivityId { get => scheduleActivityId; set => scheduleActivityId = value; }
